                ...
                <div className="col-4">
                    <ul className="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                        <li className="nav-item" role="presentation">
                            <button className={`nav-link ${this.state.active === "login" ? "active" : ""}`} id="tab-login"
                                onClick={() => this.setState({ active: "login" })}>Login</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button className={`nav-link ${this.state.active === "register" ? "active" : ""}`} id="tab-register"
                                onClick={() => this.setState({ active: "register" })}>Register</button>
                        </li>
                    </ul>

                    <div className="tab-content">
                        <div className={`tab-pane fade ${this.state.active === "login" ? "show active" : ""}`} id="pills-login">
                            <form onSubmit={this.onSubmitLogin}>

                                <div className="form-outline mb-4">
                                    <input type="text" id="loginName" name="login" className="form-control" onChange={this.onChangeHandler} />
                        ...
                        <div className={`tab-pane fade ${this.state.active === "register" ? "show active" : ""}`} id="pills-register">
                            <form onSubmit={this.onSubmitRegister}>
                                ...
                                <div className="form-outline mb-4">
                                    <input type="text" id="registerLogin" name="login" className="form-control" onChange={this.onChangeHandler} />
